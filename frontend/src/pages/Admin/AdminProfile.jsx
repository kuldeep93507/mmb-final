...
const AdminProfile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL || ""}/api/admin/profile`, {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL || ""}/api/admin/profile`, profileData, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${process.env.REACT_APP_BACKEND_URL || ""}/api/admin/change-password`, {
